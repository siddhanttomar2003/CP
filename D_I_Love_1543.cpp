...
void solve()
{
    ...
    while(st_row <= end_row && st_col <=end_col){
        ...
        for(int i=0;i<temp.size()-3;i++){
           if(temp[i]=='1' && temp[i+1]=='5' && temp[i+2]=='4' && temp[i+3]=='3')count++;
        }
        int ss=temp.size()-1;
        if(temp[ss]=='1' && temp[0]=='5' && temp[1]=='4' && temp[2]=='3')count++;
        if(temp[ss-1]=='1' && temp[ss]=='5' && temp[0]=='4' && temp[1]=='3')count++;
        if(temp[ss-2]=='1' && temp[ss-1]=='5' && temp[ss]=='4' && temp[0]=='3')count++;
        ans+=count;
