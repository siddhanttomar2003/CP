...
int32_t main()
{
    ...
    while(t--)
    {
     ...
     vl v(n);
     inv;
     // case 1:- if two times resulting array violation then no , also change the first element
     // case 2:- if not any times then always yes
     // case 3:- if one time violating 
     vl b;
     rep(i,n-1,0){
