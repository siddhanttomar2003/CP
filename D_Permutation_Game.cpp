...
int32_t main()
{
    ...
    vi v2(n);
    inv2;
    int curr_posb=sb-1;ll sum1=0;ll last_value_b=0;
    int curr_poss=ss-1;ll sum2=0;ll last_value_s=0;
    bool flag1=false;
    bool flag2=false;
    ll k2=k;
    while(k){
        sum1+=v2[curr_posb];
     if(v2[v[curr_posb]]>v2[curr_posb]){
        curr_posb=v[curr_posb]-1;
     }
     else {
        flag1=true;
        last_value_b=v2[curr_posb];
     }
     ...
     while(k2){
     sum2+=v2[curr_poss];
      if(v2[v[curr_poss]]>v2[curr_poss]){
        curr_poss=v[curr_poss]-1;
     }
     else {
        flag2=true;
        last_value_s=v2[curr_poss];
     }
