...
//     if(prefix[i]>=(i+1)/2)checkleft=true;
//     bool checkright=false;
//     if(suffix[i]>=(n-i)/2)checkright=true;
//      if(abs(n/2-i)<=diff && checkleft && checkright){
//         diff=abs(n/2-i);
//         pos=i;
//      }
// }
// if(pos==INT_MAX){
//     if(suffix[0]>=n/2)pos=0;
// }
// if(pos==INT_MAX){
//     if(prefix[n]>=n/2)pos=n;
// }
// cout<<pos<<endl;
return;
