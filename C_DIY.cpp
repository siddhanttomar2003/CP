...
void solve(){
    ...
    if(pos+1<n){
      ...
      if(maxi2==-1e9)pn;
        ...
        py;
        ll op1=(maxi1-mini1)*(maxi2-mini2);
        ll op2=(maxi2-mini1)*(maxi1-mini2);
        if(op1>op2){
            cout<<mini1<<" "<<mini2<<" "<<mini1<<" "<<maxi2<<" "<<maxi1<<" "<<maxi1<<" "<<maxi1<<" "<<maxi2<<endl;
        }
        else {
            cout<<mini1<<" "<<mini2<<" "<<mini1<<" "<<maxi1<<" "<<maxi2<<" "<<mini2<<" "<<maxi2<<" "<<maxi1<<endl;
        }
      }
